...
```{r psrange1, message=FALSE, results='hide'}
...
```{r psrange2, message=FALSE, results='hide'}
...
```{r psrange3, message=FALSE, results='hide'}
...
```{r psrange4, message=FALSE, results='hide'}
...
```{r psrange5, message=FALSE, results='hide'}
